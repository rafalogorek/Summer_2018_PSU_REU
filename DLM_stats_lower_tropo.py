...
def getAnnualMeans(wind_speeds, location_names):
    ...
    plt.xlabel('Year')
    plt.title('Annual Mean of Lower Troposphere Wind Speeds During North Atlantic\nHurricane Seasons from 1979 through 2016 on ' +
              location_names[region][1])
    plt.savefig('Figures/Lower_Tropo/Annual_Mean_Speeds/WS_79_16/Annual_Mean_Time_Series_79_16_' + location_names[region][0] + '_LT.png')
    plt.show()
    ...
    plt.text(2003, 4, 'Linear Regression Slope = ' + str(round(am_June_fit[0], 6)), fontsize = 20)
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
    plt.title('Annual Mean of Lower Troposphere Wind Speeds During the Month of\nJune from 1979 through 2016 on ' +
              location_names[region][1])
    plt.savefig('Figures/Lower_Tropo/Annual_Mean_Speeds/WS_79_16/Annual_Mean_Time_Series_79_16_' + location_names[region][0] + '_June_LT.png')
    plt.show()
    ...
    plt.text(1980, 3.3, 'Linear Regression Slope = ' + str(round(am_July_fit[0], 6)), fontsize = 20)
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
    plt.title('Annual Mean of Lower Troposphere Wind Speeds During the Month of\nJuly from 1979 through 2016 on ' +
              location_names[region][1])
    plt.savefig('Figures/Lower_Tropo/Annual_Mean_Speeds/WS_79_16/Annual_Mean_Time_Series_79_16_' + location_names[region][0] + '_July_LT.png')
    plt.show()
    ...
    plt.text(1980, 5.5, 'Linear Regression Slope = ' + str(round(am_Aug_fit[0], 6)), fontsize = 20)
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
    plt.title('Annual Mean of Lower Troposphere Wind Speeds During the Month of\nAugust from 1979 through 2016 on ' +
              location_names[region][1])
    plt.savefig('Figures/Lower_Tropo/Annual_Mean_Speeds/WS_79_16/Annual_Mean_Time_Series_79_16_' + location_names[region][0] + '_Aug_LT.png')
    plt.show()
    ...
    plt.text(1980, 4, 'Linear Regression Slope = ' + str(round(am_Sep_fit[0], 6)), fontsize = 20)
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
    plt.title('Annual Mean of Lower Troposphere Wind Speeds During the Month of\nSeptember from 1979 through 2016 on ' +
              location_names[region][1])
    plt.savefig('Figures/Lower_Tropo/Annual_Mean_Speeds/WS_79_16/Annual_Mean_Time_Series_79_16_' + location_names[region][0] + '_Sep_LT.png')
    plt.show()
    ...
    plt.text(1980, 8, 'Linear Regression Slope = ' + str(round(am_Oct_fit[0], 6)), fontsize = 20)
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
    plt.title('Annual Mean of Lower Troposphere Wind Speeds During the Month of\nOctober from 1979 through 2016 on ' +
              location_names[region][1])
    plt.savefig('Figures/Lower_Tropo/Annual_Mean_Speeds/WS_79_16/Annual_Mean_Time_Series_79_16_' + location_names[region][0] + '_Oct_LT.png')
    plt.show()
    ...
    plt.text(1980, 6.5, 'Linear Regression Slope = ' + str(round(am_Nov_fit[0], 6)), fontsize = 20)
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
    plt.title('Annual Mean of Lower Troposphere Wind Speeds During the Month of\nNovember from 1979 through 2016 on ' +
              location_names[region][1])
    plt.savefig('Figures/Lower_Tropo/Annual_Mean_Speeds/WS_79_16/Annual_Mean_Time_Series_79_16_' + location_names[region][0] + '_Nov_LT.png')
    plt.show()
    ...
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
    plt.title('Annual Means of Lower Troposphere Wind Speeds During Months of the North Atlantic\nHurricane Season from 1979 through 2016 on ' +
              location_names[region][1])
    plt.savefig('Figures/Lower_Tropo/Annual_Mean_Speeds/WS_79_16/Annual_Mean_All_Regression_Lines_79_16_' + location_names[region][0] + '_LT.png')
    plt.show()
...
p_levels = [500, 700, 850, 1000]
weights = [(float(150)/float(550)) * 100, (float(175)/float(550)) * 100, (float(150)/float(550)) * 100,
           (float(75)/float(550)) * 100]
...
ax.set_title('Neumann (1988) Deep Layer Mean Weighting Scheme Using\nPressure Levels at 500 mb and Lower', fontsize = 17)
fig.savefig('Figures/Lower_Tropo/DLM_weights_LT.png')
plt.show()
...
plt.title('Average Wind Speeds During the ' + str(current_year) + ' Hurricane Season on ' +
          location_names[region][1])
#plt.savefig('Figures/Time_Series/' + str(current_year) + '/Filtered_' + location_names[region][0]  + '_Time_Series_' + str(current_year) + '_LT.png')
#plt.savefig('Figures/Time_Series/Yearly/Filtered_' + location_names[region][0]  + '_Time_Series_' + str(current_year) + '_LT.png')
plt.show()
...
plt.title('Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nDuring ' +
          'North Atlantic Hurricane Seasons from 1979 up to 2017')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-16/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_Histogram_LT.png')
plt.show()
...
#plt.savefig('Figures/Translation_Speeds/' + location_names[region][0]  + '/Filtered_Norm_Trans_Speeds_' + location_names[region][0] + '_79-16_Histogram_LT.png')
#plt.savefig('Figures/Translation_Speeds/TS_79-16/Filtered_Norm_Trans_Speeds_' + location_names[region][0] + '_79-16_Histogram_LT.png')
plt.show()
...
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_EHS_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-16_EHS/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_EHS_Histogram_LT.png')
plt.show()
...
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_June_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-16_June/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_June_Histogram_LT.png')
plt.show()
...
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_July_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-16_July/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_July_Histogram_LT.png')
plt.show()
...
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_MHS_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-16_MHS/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_MHS_Histogram_LT.png')
plt.show()
...
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_MHS_v2_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-16_MHS_v2/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_MHS_v2_Histogram_LT.png')
plt.show()
...
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_Aug_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-16_Aug/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_Aug_Histogram_LT.png')
plt.show()
...
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_Sep_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-16_Sep/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_Sep_Histogram_LT.png')
plt.show()
...
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_LHS_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-16_LHS/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_LHS_Histogram_LT.png')
plt.show()
...
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_LHS_v2_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-16_LHS_v2/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_LHS_v2_Histogram_LT.png')
plt.show()
...
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_Oct_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-16_Oct/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_Oct_Histogram_LT.png')
plt.show()
...
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_Nov_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-16_Nov/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-16_Nov_Histogram_LT.png')
plt.show()
...
ax.set_title('Average Lower Troposphere Wind Speeds During North Atlantic Hurricane Seasons', fontsize = 30)
ax.xaxis.set_major_formatter(mdates.DateFormatter('%B'))
ax.legend(loc = 2, fontsize = 25)
fig.savefig('Figures/Lower_Tropo/Time_Series/Yearly/Filtered_' + location_names[region][0]  + '_Time_Series_3d_Avg_Comparison_LT.png')
plt.show()
...
plt.ylabel('Wind Speed (m/s)')
plt.xlabel('Time')
plt.title('Difference Between Three Day Average Lower Troposphere Wind Speeds During Hurricane Seasons from 1979 through 1997\n' +
          'and Hurricane Seasons from 1998 through 2016 on ' + location_names[region][1])
plt.savefig('Figures/Lower_Tropo/Time_Series/Yearly/Filtered_' + location_names[region][0]  + '_Time_Series_3d_Avg_Comparison_Diff_LT.png')
plt.show()
...
plt.subplots_adjust(left = 0.125, bottom = 0.1, right = 0.9, top = 0.9, wspace = 0.2,
                    hspace = 0.5)
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_79-97_98-16/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_Histogram_LT.png')
plt.show()
...
plt.subplots_adjust(left = 0.125, bottom = 0.1, right = 0.9, top = 0.9, wspace = 0.2,
                    hspace = 0.5)
#plt.savefig('Figures/Translation_Speeds/' + location_names[region][0]  + '/Filtered_Norm_Trans_Speeds_' + location_names[region][0] + '_79-97_98-16_Histogram_LT.png')
#plt.savefig('Figures/Translation_Speeds/WS_79-97_98-16/Filtered_Norm_Trans_Speeds_' + location_names[region][0] + '_79-97_98-16_Histogram_LT.png')
plt.show()
...
ax.set_title('Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nDuring ' +
             'Hurricane Seasons from 1979 up to 1998\nvs. Hurricane Seasons from ' +
             '1998 up to 2017')

ax.legend()
fig.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_SBS_Histogram_LT.png')
fig.savefig('Figures/Lower_Tropo/WS_79-97_98-16_SBS/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_SBS_Histogram_LT.png')
plt.show()
...
ax.legend()
#fig.savefig('Figures/Translation_Speeds/' + location_names[region][0]  + '/Filtered_Norm_Trans_Speeds_' + location_names[region][0] + '_79-97_98-16_SBS_Histogram_LT.png')
#fig.savefig('Figures/Translation_Speeds/WS_79-97_98-16_SBS/Filtered_Norm_Trans_Speeds_' + location_names[region][0] + '_79-97_98-16_SBS_Histogram_LT.png')
plt.show()
...
plt.title('Difference Between Normalized Frequencies of Lower Troposphere Wind Speeds')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_Diff_79-97_98-16/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_Histogram_LT.png')
plt.show()
...
#plt.savefig('Figures/Translation_Speeds/' + location_names[region][0]  + '/Filtered_Norm_Trans_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_Histogram_LT.png')
#plt.savefig('Figures/Translation_Speeds/WS_Diff_79-97_98-16/Filtered_Norm_Trans_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_Histogram_LT.png')
plt.show()
...
ax.set_xlabel('Wind Speed (m/s)')
ax.set_ylabel('Frequency (%)')
ax.set_title('Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + ' in Late\nMay, ' +
             'June, and July During Hurricane Seasons from 1979 up to 1998\nvs. Hurricane ' +
             'Seasons from 1998 up to 2017')
ax.legend()
fig.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_EHS_SBS_Histogram_LT.png')
fig.savefig('Figures/Lower_Tropo/WS_79-97_98-16_EHS_SBS/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_EHS_SBS_Histogram_LT.png')
plt.show()
...
ax.set_xlabel('Wind Speed (m/s)')
ax.set_ylabel('Frequency (%)')
ax.set_title('Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + ' in\nAugust ' +
             'and September During Hurricane Seasons from 1979 up to\n1998 vs. Hurricane ' +
             'Seasons from 1998 up to 2017')
ax.legend()
fig.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_MHS_SBS_Histogram_LT.png')
fig.savefig('Figures/Lower_Tropo/WS_79-97_98-16_MHS_SBS/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_MHS_SBS_Histogram_LT.png')
plt.show()
...
ax.set_title('Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + ' in\nJuly ' +
             ...
             'Seasons from 1998 up to 2017')
ax.legend()
fig.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_MHS_v2_SBS_Histogram_LT.png')
fig.savefig('Figures/Lower_Tropo/WS_79-97_98-16_MHS_v2_SBS/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_MHS_v2_SBS_Histogram_LT.png')
plt.show()
...
#             'Seasons from 1998 up to 2017')
#ax.legend()
#fig.savefig('Figures/' + location_names[region][0]  + '/Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_Aug_SBS_Histogram_LT.png')
#fig.savefig('Figures/WS_79-97_98-16_Aug_SBS/Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_Aug_SBS_Histogram_LT.png')
#plt.show()
...
#             'Seasons from 1998 up to 2017')
#ax.legend()
#fig.savefig('Figures/' + location_names[region][0]  + '/Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_Sep_SBS_Histogram_LT.png')
#fig.savefig('Figures/WS_79-97_98-16_Sep_SBS/Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_Sep_SBS_Histogram_LT.png')
#plt.show()
...
ax.set_title('Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + ' in\nOctober ' +
             ...
             'Seasons from 1998 up to 2017')
ax.legend()
fig.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_LHS_SBS_Histogram_LT.png')
fig.savefig('Figures/Lower_Tropo/WS_79-97_98-16_LHS_SBS/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_LHS_SBS_Histogram_LT.png')
plt.show()
...
ax.set_title('Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + ' in\nSeptember ' +
             ...
             'Seasons from 1998 up to 2017')
ax.legend()
fig.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_LHS_v2_SBS_Histogram_LT.png')
fig.savefig('Figures/Lower_Tropo/WS_79-97_98-16_LHS_v2_SBS/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_LHS_v2_SBS_Histogram_LT.png')
plt.show()
...
plt.ylabel('Frequency Difference (%)')
plt.xlabel('Wind Speed (m/s)')
plt.title('Difference Between Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nin Late ' +
          'May, June, and July During Hurricane Seasons from 1979 up to 1998\nand During Hurricane ' +
          'Seasons from 1998 up to 2017')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_EHS_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_Diff_79-97_98-16_EHS/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_EHS_Histogram_LT.png')
plt.show()
...
plt.title('Difference Between Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nin the Month ' +
          ...
          'Seasons from 1998 up to 2017')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_June_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_Diff_79-97_98-16_June/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_June_Histogram_LT.png')
plt.show()
...
plt.title('Difference Between Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nin the Month ' +
          ...
          'Seasons from 1998 up to 2017')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_July_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_Diff_79-97_98-16_July/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_July_Histogram_LT.png')
plt.show()
...
plt.title('Difference Between Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nin August ' +
          ...
          'Seasons from 1998 up to 2017')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_MHS_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_Diff_79-97_98-16_MHS/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_MHS_Histogram_LT.png')
plt.show()
...
plt.title('Difference Between Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nin July ' +
          ...
          'Seasons from 1998 up to 2017')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_MHS_v2_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_Diff_79-97_98-16_MHS_v2/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_MHS_v2_Histogram_LT.png')
plt.show()
...
plt.title('Difference Between Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nin the Month ' +
          'of August During Hurricane Seasons from 1979 up to 1998\nand During Hurricane ' +
          'Seasons from 1998 up to 2017')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_Aug_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_Diff_79-97_98-16_Aug/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_Aug_Histogram_LT.png')
plt.show()
...
plt.title('Difference Between Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nin the Month ' +
          ...
          'Seasons from 1998 up to 2017')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_Sep_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_Diff_79-97_98-16_Sep/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_Sep_Histogram_LT.png')
plt.show()
...
plt.ylabel('Frequency Difference (%)')
plt.xlabel('Wind Speed (m/s)')
plt.title('Difference Between Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nin October ' +
          'and November During Hurricane Seasons from 1979 up to 1998\nand During Hurricane ' +
          'Seasons from 1998 up to 2017')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_LHS_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_Diff_79-97_98-16_LHS/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_LHS_Histogram_LT.png')
plt.show()
...
plt.title('Difference Between Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nin September ' +
          ...
          'Seasons from 1998 up to 2017')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_LHS_v2_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_Diff_79-97_98-16_LHS_v2/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_LHS_v2_Histogram_LT.png')
plt.show()
...
plt.title('Difference Between Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nin the Month ' +
          ...
          'Seasons from 1998 up to 2017')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_Oct_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_Diff_79-97_98-16_Oct/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_Oct_Histogram_LT.png')
plt.show()
...
plt.title('Difference Between Normalized Frequency of Lower Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nin the Month ' +
          ...
          'Seasons from 1998 up to 2017')
plt.savefig('Figures/Lower_Tropo/' + location_names[region][0]  + '/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_Nov_Histogram_LT.png')
plt.savefig('Figures/Lower_Tropo/WS_Diff_79-97_98-16_Nov/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_Diff_Between_79-97_and_98-16_Nov_Histogram_LT.png')
plt.show()
...
plt.xlabel('Wind Speed (m/s)')
plt.title('June')
plt.suptitle('Difference Between Normalized Frequencies of Lower Troposphere Wind Speeds', fontsize = 35)
...
plt.savefig('Figures/Lower_Tropo/Filtered_Norm_Wind_Speeds_' + location_names[region][0] + '_79-97_98-16_Diff_2x2_Histogram_LT.png')
plt.show()
...
#plt.savefig('Figures/' + location_names[region][0]  + '/Wind_Speed_Measurement_Locations_' + location_names[region][0] + '_LT.png')
#plt.savefig('Figures/Measurement_Locations/Wind_Speed_Measurement_Locations_' + location_names[region][0] + '_LT.png')
plt.show()
