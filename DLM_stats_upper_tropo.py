...
def getAnnualMeans(wind_speeds, location_names):
    ...
    plt.text(1980, 16, 'Linear Regression Slope = ' + str(round(am_fit[0], 6)), fontsize = 20)
    ...
    plt.text(2002, 14, 'Linear Regression Slope = ' + str(round(am_June_fit[0], 6)), fontsize = 20)
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
    ...
    plt.text(1980, 9, 'Linear Regression Slope = ' + str(round(am_July_fit[0], 6)), fontsize = 20)
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
    ...
    plt.text(1995, 6, 'Linear Regression Slope = ' + str(round(am_Aug_fit[0], 6)), fontsize = 20)
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
    ...
    plt.text(2000, 16, 'Linear Regression Slope = ' + str(round(am_Sep_fit[0], 6)), fontsize = 20)
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
    ...
    plt.text(2000, 25, 'Linear Regression Slope = ' + str(round(am_Oct_fit[0], 6)), fontsize = 20)
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
    ...
    plt.text(1980, 32, 'Linear Regression Slope = ' + str(round(am_Nov_fit[0], 6)), fontsize = 20)
    plt.ylabel('Wind Speed (m/s)')
    plt.xlabel('Year')
...
p_levels = [100, 150, 200, 250, 300, 400]
weights = [(float(25)/float(350)) * 100, (float(50)/float(350)) * 100, (float(50)/float(350)) * 100,
           (float(50)/float(350)) * 100, (float(75)/float(350)) * 100, (float(100)/float(350)) * 100]
...
# Plot a three day moving average time series of the winds
...
ax.set_title('a.) Upper Troposphere', fontsize = 35)
...
ax.set_title('Normalized Frequency of Upper Troposphere Wind Speeds Recorded on ' + location_names[region][1] + '\nDuring ' +
...
ax.set_xlabel('Wind Speed (m/s)')
ax.set_ylabel('Frequency (%)')
ax.set_title('Normalized Frequency of Upper Troposphere Wind Speeds Recorded on ' + location_names[region][1] + ' in Late\nMay, ' +
...
ax.set_xlabel('Wind Speed (m/s)')
ax.set_ylabel('Frequency (%)')
ax.set_title('Normalized Frequency of Upper Troposphere Wind Speeds Recorded on ' + location_names[region][1] + ' in\nAugust ' +
...
plt.xlabel('Wind Speed (m/s)')
plt.title('June')
plt.suptitle('Difference Between Normalized Frequencies of Upper Troposphere Wind Speeds', fontsize = 35)
