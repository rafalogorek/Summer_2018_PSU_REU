...
def main():
	...
	np.savez('subset_mean_winds_ERA_upper_tropo.npz',deepu=deepu,deepv=deepv,lat=lat,lon=lon,dates=dates,wspd=wspd,wdir=wdir)	
...
def deep_mean(wind, plev):
	...
	wgts=np.asarray([100,75,50,50,50,25])
	wgts=wgts/350.

	critp=[400,300,250,200,150,100]
