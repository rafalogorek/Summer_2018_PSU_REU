...
def main():
	...
	np.savez('subset_mean_winds_ERA_lower_tropo.npz',deepu=deepu,deepv=deepv,lat=lat,lon=lon,dates=dates,wspd=wspd,wdir=wdir)	
...
def deep_mean(wind, plev):
	...
	wgts=np.asarray([75,150,175,150])
	wgts=wgts/550.

	critp=[1000,850,700,500]
